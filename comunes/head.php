<header>
        ...
        <div class="sidebar fixed top-0 bottom-0 lg:left-0 left-[-300px] duration-1000 
            ...
            <div class="p-2.5 mt-1 flex items-center rounded-md ">
                ...
                <a href="?pagina=inicio"><i class="fa-solid fa-house px-2 py-2 bg-red-800 rounded-md text-white hover:text-white"></i></a>
                <a href="?pagina=inicio" class="text-[15px]  ml-3 text-xl text-stone-600 font-bold cursor-pointer text-stone-500 hover:text-stone-800">CDI - Carmen Estella Mendoza de Flores</a>
                <a href="?pagina=inicio"><i class="bi bi-x ml-20 cursor-pointer lg:hidden cursor-pointer hover:text-white" onclick="Openbar()"></i></a>
            </div>
            <hr class="my-2 text-gray-600">

            <div>
                <div class="p-2.5 mt-3 flex items-center rounded-md px-4 duration-300 cursor-pointer bg-red-800">
                <i class="bi bi-search text-sm hover:text-white"></i>
                ...
                <div class="p-2.5 mt-2 flex items-center rounded-md px-4 duration-300 cursor-pointer hover:bg-red-800 hover:text-white text-stone-600">
                    <i class="fa-solid fa-desktop hover:text-white"></i>
                    <a href="?pagina=inicio"><span class="text-[15px] ml-4 text-lg hover:text-white">Escritorio</span></a>
                </div>
